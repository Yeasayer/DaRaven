...
//Standard Constructor
    NounsNAdjectives(){
        ...
        InputStream sta=getClass().getClassLoader().getResourceAsStream(afile);
        InputStream stn=getClass().getClassLoader().getResourceAsStream(nfile);
        //ClassLoader cl = ClassLoader.getSystemClassLoader();
        
        try{
            //String a2 = cl.getResource(afile).getFile();
            //String n2 = cl.getResource(nfile).getFile();
            //System.out.println(a2+"-_-"+n2);
            this.nouns = this.getWords(stn);
            this.adjectives = this.getWords(sta);
